function navbar() {
  ...
  <div class="upper">
    <a href="/" class="logo"
      ><img src="/static/assets/logo_big.svg" alt="Logo"
    /></a>
    <div class="search-bar">
      <div class="search-bar-container">
        <img src="/static/assets/search_logo.png" alt="searchLogo" />
        <input
          type="text"
          class="search"
    ...
    <div class="link-section">
      <div class="log-in-link">
        <a href="#" class="login-sidebar-link">
          <img src="/static/assets/login_logo.png" alt="login" />
          <span>Hello, Log in</span>
        </a>
      </div>
      <div class="offers-link">
        <a href="#">
          <img src="/static/assets/discount_logo.png" alt="discount" />
          <span>Offers</span>
        </a>
      </div>
      <div class="cart-link">
        <a href="./cart.html">
          <img src="/static/assets/cart_logo.png" alt="cart" />
          <span>Cart</span>
        </a>
      </div>
    </div>
